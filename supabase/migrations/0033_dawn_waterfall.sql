/*
  # Fix news comments table structure

  1. Changes
    - Recreate news_comments table with proper foreign key relationships
...
-- Create a secure view for comments with user information
